   ...
   setTimeout(function(){
     ...
     $('#news').addClass('animated slideInRight').show();
      ...
      $('#getFile8').on('click', function () {
               $.ajax({
                 url: 'http://www.elizabethrodricks.com/images5/nuclear2.jpg',
                 method: 'GET',
                 xhrFields: {
                   responseType: 'blob'
                 },
         ...
         $('#getFile9').on('click', function () {
                      $.ajax({
                        url: 'http://www.elizabethrodricks.com/images5/nuclear3.jpg',
                        method: 'GET',
                        xhrFields: {
                          responseType: 'blob'
                        },
            ...
            $('#getFile10').on('click', function () {
                     $.ajax({
                       url: 'http://www.elizabethrodricks.com/images5/nuclear4.jpg',
                       method: 'GET',
                       xhrFields: {
                         responseType: 'blob'
                       },
           ...
           $('#getFile11').on('click', function () {
             $.ajax({
               url: 'http://www.elizabethrodricks.com/images5/nuclear5.jpg',
               method: 'GET',
               xhrFields: {
                 responseType: 'blob'
               },
