...
//my vertical carousel for videos
  ...
  let pageModule = {
    ...
    $("#openIt").click(function(){
      ...
      $("html, body").animate({scrollTop: pageModule.getNavFixedHeight() -100}, 950);

      $('#myCool').addClass('flexing flexing-scroll').animate({"height" : "auto",
       "top": pageModule.getNavFixedHeight(),}, 1000).delay('1000').fadeIn();
  ...
  setTimeout(function(){
        $("html, body").animate({scrollTop: pageModule.getMiddleFixedHeight()}, 1000);
  },200);
      ...
      setTimeout(function(){
          $('#myCool').addClass('animated slideDown').animate({"height" : "0px",
           "top": pageModule.getMiddleFixedHeight() +  200}, 600).fadeOut();
       },100);
    ...
    setTimeout(function(){
     $('.center').slideDown();
      $('.trans--grow').fadeIn().removeClass('zero');
    }, 700);
