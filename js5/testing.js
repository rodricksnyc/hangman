   ...
   setTimeout(function(){
     ...
     $('#news').addClass('animated slideInRight').show();
          ...
          $('#getFile6').on('click', function () {
            $.ajax({
              url: 'http://www.elizabethrodricks.com/images5/test-benefits1.jpg',
              method: 'GET',
              xhrFields: {
                responseType: 'blob'
              },
       ...
       $('#getFile7').on('click', function () {
            $.ajax({
              url: 'http://www.elizabethrodricks.com/images5/test-benefits2.jpg',
              method: 'GET',
              xhrFields: {
                responseType: 'blob'
              },
      ...
      $('#getFile8').on('click', function () {
               $.ajax({
                 url: 'http://www.elizabethrodricks.com/images5/test-ben.jpg',
                 method: 'GET',
                 xhrFields: {
                   responseType: 'blob'
                 },
         ...
         $('#getFile9').on('click', function () {
                      $.ajax({
                        url: 'http://www.elizabethrodricks.com/images5/test-benefits3.jpg',
                        method: 'GET',
                        xhrFields: {
                          responseType: 'blob'
                        },
            ...
            $('#getFile10').on('click', function () {
                     $.ajax({
                       url: 'http://www.elizabethrodricks.com/images5/test-benefits4.jpg',
                       method: 'GET',
                       xhrFields: {
                         responseType: 'blob'
                       },
