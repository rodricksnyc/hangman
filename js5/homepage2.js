...
$('#videos').click(function(){
  ...
  $('#myCool').animate({ width: 'hide' }, 1200);


  setTimeout(function(){
 $('#myCool').addClass('slideThis1')
}, 1000);
...
$('#hiddenVideosNew').css('position','unset', 'important');
 $('#hiddenVideosNew').addClass('animated slideInRight');
...
//
  setTimeout(function(){
   ...
   $('#hiddenVideosNew').removeClass('animated slideInRight');
   $('#hiddenVideosNew').addClass('animated slideInLeft');
   // $('#hiddenVideosNew').css('position','absolute', 'important');
...
$('#myCool').animate({ width: 'show' }, 1050);


setTimeout(function(){
 $('#myCool').removeClass('slideThis1');
  $('#myCool').addClass('animated slideInLeft');
}, 1100);
