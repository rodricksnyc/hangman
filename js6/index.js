...
// if ( $===undefined ) return;
//
// var c0_0 = rainbows[rainbowIndices[0]];
// var c0_1 = rainbows[rainbowIndices[1]];
// var c1_0 = rainbows[rainbowIndices[2]];
// var c1_1 = rainbows[rainbowIndices[3]];
//
// var istep = 1 - step;
// var r1 = Math.round(istep * c0_0[0] + step * c0_1[0]);
// var g1 = Math.round(istep * c0_0[1] + step * c0_1[1]);
// var b1 = Math.round(istep * c0_0[2] + step * c0_1[2]);
// var rainbow1 = "rgb("+r1+","+g1+","+b1+")";
//
// var r2 = Math.round(istep * c1_0[0] + step * c1_1[0]);
// var g2 = Math.round(istep * c1_0[1] + step * c1_1[1]);
// var b2 = Math.round(istep * c1_0[2] + step * c1_1[2]);
// var rainbow2 = "rgb("+r2+","+g2+","+b2+")";
//
// $('#gradient').css({
//  background: "-webkit-gradient(linear, left top, right top, from("+rainbow1+"), to("+rainbow2+"))"}).css({
//   background: "-moz-linear-gradient(left, "+rainbow1+" 0%, "+rainbow2+" 100%)"});
//
// step += gradientSpeed;
// if ( step >= 1 )
// {
//   step %= 1;
//   rainbowIndices[0] = rainbowIndices[1];
//   rainbowIndices[2] = rainbowIndices[3];
//
//   //pick two new target color indices
//   //do not pick the same as the current one
//   rainbowIndices[1] = ( rainbowIndices[1] + Math.floor( 1 + Math.random() * (rainbows.length - 1))) % rainbows.length;
//   rainbowIndices[3] = ( rainbowIndices[3] + Math.floor( 1 + Math.random() * (rainbows.length - 1))) % rainbows.length;
//
// }
// }
//
